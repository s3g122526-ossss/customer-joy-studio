...
export type CaddyStatus = "idle" | "picking" | "onway" | "delivered";
...
/** Replace with: api.get<Caddy>("/caddies/me/assigned/") */
...
/** Replace with: api.post(`/orders/${orderId}/caddy/rate/`, { stars, note }) */
export async function rateCaddy(_orderId: string, _stars: number, _note?: string): Promise<void> {
  return;
}
